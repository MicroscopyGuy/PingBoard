...
public readonly partial struct StartProbeRequest
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("#/components/schemas/StartProbeRequest");
        }
    ...
    public static partial class CorvusValidation
    {
            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            ValidationContext oneOfResult0 = value.As<JsonSchemaGeneratedTypes.PingProbeConfig>().Validate(oneOfChildContext0, level);
            ...
            ValidationContext oneOfResult1 = value.As<JsonSchemaGeneratedTypes.TracerouteProbeConfig>().Validate(oneOfChildContext1, level);
