...
public readonly partial struct ProbeSchema
{
    ...
    public readonly partial struct TracerouteProbeConfigSchema
    {
        ...
        public readonly partial struct DoReverseDnsEntity
            : IJsonBoolean<PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.TracerouteProbeConfigSchema.DoReverseDnsEntity>
        {
            /// <summary>
            /// Conversion from <see cref="bool"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator DoReverseDnsEntity(bool value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator DoReverseDnsEntity(JsonBoolean value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonBoolean(DoReverseDnsEntity value)
            {
                return
                    value.AsBoolean;
            }
            ...
            public static implicit operator bool(DoReverseDnsEntity value)
            {
