...
#if NET8_0_OR_GREATER
            : IJsonNumber<PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TimeoutEntity>,
              IAdditionOperators<PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TimeoutEntity, PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TimeoutEntity, PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TimeoutEntity>,
              ISubtractionOperators<PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TimeoutEntity, PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TimeoutEntity, PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TimeoutEntity>,
              IMultiplyOperators<PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TimeoutEntity, PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TimeoutEntity, PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TimeoutEntity>,
              IDivisionOperators<PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TimeoutEntity, PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TimeoutEntity, PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TimeoutEntity>,
              IIncrementOperators<PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TimeoutEntity>,
              IDecrementOperators<PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TimeoutEntity>
#else
            : IJsonNumber<PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TimeoutEntity>
#endif
        {
            ...
            public TimeoutEntity(double value)
            ...
            public static implicit operator double(TimeoutEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TimeoutEntity"/>.</returns>
            public static implicit operator TimeoutEntity(double value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator long(TimeoutEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TimeoutEntity"/>.</returns>
            public static explicit operator TimeoutEntity(long value)
            {
                return new(new BinaryJsonNumber(value));
            }
