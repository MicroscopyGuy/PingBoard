    ...
    public readonly partial struct ProbeIdentifiersEntityArray
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("#/components/schemas/StopProbeRequest/properties/probeIdentifiers");
            }
        ...
        public static partial class CorvusValidation
        {
            ...
            internal static ValidationContext ArrayValidationHandler(
                in ProbeIdentifiersEntityArray value,
                JsonValueKind valueKind,
                in ValidationContext validationContext,
                ValidationLevel level)
            {
                ...
                int length = 0;
                using JsonArrayEnumerator<JsonSchemaGeneratedTypes.StopProbeRequest.ProbeIdentifiersEntityArray.ProbeIdentifiersEntity> arrayEnumerator = value.EnumerateArray();
