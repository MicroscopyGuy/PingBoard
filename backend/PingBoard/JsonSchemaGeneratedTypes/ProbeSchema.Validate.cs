...
public readonly partial struct ProbeSchema
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("probe.schema.json");
        }
    ...
    public static partial class CorvusValidation
    {
            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            ValidationContext anyOfResult0 = value.As<PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema>().Validate(anyOfChildContext0, level);
            ...
            ValidationContext anyOfResult1 = value.As<PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.TracerouteProbeConfigSchema>().Validate(anyOfChildContext1, level);
