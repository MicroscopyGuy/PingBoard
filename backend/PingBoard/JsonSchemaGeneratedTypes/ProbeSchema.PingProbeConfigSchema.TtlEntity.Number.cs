...
public readonly partial struct ProbeSchema
{
    ...
    public readonly partial struct PingProbeConfigSchema
    {
        ...
        /// </para>
        /// </remarks>
        public readonly partial struct TtlEntity
#if NET8_0_OR_GREATER
            : IJsonNumber<PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TtlEntity>,
              IAdditionOperators<PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TtlEntity, PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TtlEntity, PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TtlEntity>,
              ISubtractionOperators<PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TtlEntity, PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TtlEntity, PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TtlEntity>,
              IMultiplyOperators<PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TtlEntity, PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TtlEntity, PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TtlEntity>,
              IDivisionOperators<PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TtlEntity, PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TtlEntity, PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TtlEntity>,
              IIncrementOperators<PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TtlEntity>,
              IDecrementOperators<PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TtlEntity>
#else
            : IJsonNumber<PingBoard.JsonSchemaGeneratedTypes.ProbeSchema.PingProbeConfigSchema.TtlEntity>
#endif
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "TtlEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            public TtlEntity(double value)
            ...
            public static implicit operator TtlEntity(JsonNumber value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonNumber(TtlEntity value)
            {
                return
                    value.AsNumber;
            }
            ...
            public static explicit operator byte(TtlEntity value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TtlEntity"/>.</returns>
            public static explicit operator TtlEntity(byte value)
            {
            ...
            public static explicit operator decimal(TtlEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TtlEntity"/>.</returns>
            public static explicit operator TtlEntity(decimal value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static implicit operator double(TtlEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TtlEntity"/>.</returns>
            public static implicit operator TtlEntity(double value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator short(TtlEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TtlEntity"/>.</returns>
            public static explicit operator TtlEntity(short value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator int(TtlEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TtlEntity"/>.</returns>
            public static explicit operator TtlEntity(int value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator long(TtlEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TtlEntity"/>.</returns>
            public static explicit operator TtlEntity(long value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator Int128(TtlEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TtlEntity"/>.</returns>
            public static explicit operator TtlEntity(Int128 value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            public static explicit operator sbyte(TtlEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TtlEntity"/>.</returns>
            public static explicit operator TtlEntity(sbyte value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator Half(TtlEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TtlEntity"/>.</returns>
            public static explicit operator TtlEntity(Half value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            public static explicit operator float(TtlEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TtlEntity"/>.</returns>
            public static explicit operator TtlEntity(float value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator ushort(TtlEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TtlEntity"/>.</returns>
            public static explicit operator TtlEntity(ushort value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator uint(TtlEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TtlEntity"/>.</returns>
            public static explicit operator TtlEntity(uint value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator ulong(TtlEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TtlEntity"/>.</returns>
            public static explicit operator TtlEntity(ulong value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator UInt128(TtlEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TtlEntity"/>.</returns>
            public static explicit operator TtlEntity(UInt128 value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            /// </returns>
            public static bool operator <(TtlEntity left, TtlEntity right)
            {
            ...
            public static TtlEntity operator +(TtlEntity left, TtlEntity right)
            {
            ...
            /// <returns>The result of the operation.</returns>
            public static TtlEntity operator ++(TtlEntity value)
            {
            ...
            /// </returns>
            public static int Compare(in TtlEntity lhs, in TtlEntity rhs)
            {
