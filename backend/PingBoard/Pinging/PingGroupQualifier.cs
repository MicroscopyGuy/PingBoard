...
/// </summary>
public class PingGroupQualifier{
    ...
    public PingGroupQualifier(IOptions<PingingThresholdsConfig> pingThresholds){
    ...
    public static string DescribePingQualityFlags(ThresholdExceededFlags pingQualityFlags){
        ...
        if (PingGroupQualifier.PingQualityWithinThresholds(pingQualityFlags)){
            return "";
        }
