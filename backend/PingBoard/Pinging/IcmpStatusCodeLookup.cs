...
public static class IcmpStatusCodeLookup{
    ...
    ///           deserializing this data into StatusCodes (IImmutableDictionary) since the each IPStatus' ordinal value
    ...
    ///   </seealso>
    /// </summary>
    private static readonly IImmutableDictionary<IpStatusExtensions.DisambiguatedIpStatus, 
                                                IcmpStatusCodeEntry> StatusCodes;
    ...
    public static IcmpStatusCodeEntry Lookup(IPStatus ipStatus)
    {
        return StatusCodes[ipStatus.Disambiguate()];
    }
