...
{
    private readonly Channel<ServerEventBase> _serverEventChannel;
    ...
    public ServerEventEmitter(
        Channel<ServerEventBase> serverEventChannel,
    ...
    public void IndicateServerEvent(ServerEventBase serverEvent, string caller)
    {
        try
        {
